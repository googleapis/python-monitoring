...
class ListUptimeCheckConfigsResponse(proto.Message):
    ...
    uptime_check_configs = proto.RepeatedField(proto.MESSAGE, number=1,
...
class CreateUptimeCheckConfigRequest(proto.Message):
    ...
    uptime_check_config = proto.Field(proto.MESSAGE, number=2,
        message=uptime.UptimeCheckConfig,
    )
...
class UpdateUptimeCheckConfigRequest(proto.Message):
    ...
    uptime_check_config = proto.Field(proto.MESSAGE, number=3,
        message=uptime.UptimeCheckConfig,
    )
...
class ListUptimeCheckIpsResponse(proto.Message):
    ...
    uptime_check_ips = proto.RepeatedField(proto.MESSAGE, number=1,
