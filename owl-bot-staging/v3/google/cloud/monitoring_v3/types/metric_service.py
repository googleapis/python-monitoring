...
class ListMetricDescriptorsResponse(proto.Message):
    ...
    metric_descriptors = proto.RepeatedField(proto.MESSAGE, number=1,
...
class CreateMetricDescriptorRequest(proto.Message):
    ...
    metric_descriptor = proto.Field(proto.MESSAGE, number=2,
        message=ga_metric.MetricDescriptor,
    )
...
class ListTimeSeriesRequest(proto.Message):
    ...
    interval = proto.Field(proto.MESSAGE, number=4,
        message=common.TimeInterval,
    )

    aggregation = proto.Field(proto.MESSAGE, number=5,
        message=common.Aggregation,
    )

    secondary_aggregation = proto.Field(proto.MESSAGE, number=11,
        message=common.Aggregation,
    )

    order_by = proto.Field(proto.STRING, number=6)

    view = proto.Field(proto.ENUM, number=7,
        enum=TimeSeriesView,
    )
...
class ListTimeSeriesResponse(proto.Message):
    ...
    time_series = proto.RepeatedField(proto.MESSAGE, number=1,
        message=gm_metric.TimeSeries,
    )

    next_page_token = proto.Field(proto.STRING, number=2)

    execution_errors = proto.RepeatedField(proto.MESSAGE, number=3,
...
class CreateTimeSeriesRequest(proto.Message):
    ...
    time_series = proto.RepeatedField(proto.MESSAGE, number=2,
        message=gm_metric.TimeSeries,
    )
...
class CreateTimeSeriesError(proto.Message):
    ...
    time_series = proto.Field(proto.MESSAGE, number=1,
        message=gm_metric.TimeSeries,
    )
...
class CreateTimeSeriesSummary(proto.Message):
    ...
    errors = proto.RepeatedField(proto.MESSAGE, number=3,
        message=Error,
    )
...
class QueryTimeSeriesResponse(proto.Message):
    ...
    time_series_descriptor = proto.Field(proto.MESSAGE, number=8,
        message=gm_metric.TimeSeriesDescriptor,
    )

    time_series_data = proto.RepeatedField(proto.MESSAGE, number=9,
        message=gm_metric.TimeSeriesData,
    )

    next_page_token = proto.Field(proto.STRING, number=10)

    partial_errors = proto.RepeatedField(proto.MESSAGE, number=11,
        message=gr_status.Status,
    )
