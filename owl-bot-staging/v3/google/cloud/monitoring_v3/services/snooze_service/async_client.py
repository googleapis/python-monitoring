...
class SnoozeServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(SnoozeServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(SnoozeServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(SnoozeServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(SnoozeServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(SnoozeServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(SnoozeServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(SnoozeServiceClient.common_project_path)
    parse_common_project_path = staticmethod(SnoozeServiceClient.parse_common_project_path)
    common_location_path = staticmethod(SnoozeServiceClient.common_location_path)
    parse_common_location_path = staticmethod(SnoozeServiceClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(SnoozeServiceClient).get_transport_class, type(SnoozeServiceClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Union[str, SnoozeServiceTransport] = "grpc_asyncio",
