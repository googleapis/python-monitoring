...
class ServiceMonitoringServiceClient(metaclass=ServiceMonitoringServiceClientMeta):
    ...
    @staticmethod
    def service_level_objective_path(project: str,service: str,service_level_objective: str,) -> str:
        """Returns a fully-qualified service_level_objective string."""
        return "projects/{project}/services/{service}/serviceLevelObjectives/{service_level_objective}".format(project=project, service=service, service_level_objective=service_level_objective, )
    ...
    def parse_service_level_objective_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/services/(?P<service>.+?)/serviceLevelObjectives/(?P<service_level_objective>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def delete_service(self,
        ...
        .. code-block::
            ...
            def sample_delete_service():
                ...
                # Make the request
                response = client.delete_service(request=request)
    ...
    def create_service_level_objective(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_service_level_objective]
    ...
    def get_service_level_objective(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_service_level_objective]
    ...
    def list_service_level_objectives(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_service_level_objectives]
    ...
    def update_service_level_objective(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_service_level_objective]
    ...
    def delete_service_level_objective(self,
        ...
        .. code-block::
            ...
            def sample_delete_service_level_objective():
                ...
                # Make the request
                response = client.delete_service_level_objective(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_service_level_objective]
