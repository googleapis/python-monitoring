...
class ServiceMonitoringServiceGrpcAsyncIOTransport(ServiceMonitoringServiceTransport):
    ...
    def create_service_level_objective(self) -> Callable[
        ...
        if 'create_service_level_objective' not in self._stubs:
            self._stubs['create_service_level_objective'] = self.grpc_channel.unary_unary(
    ...
    def list_service_level_objectives(self) -> Callable[
        ...
        if 'list_service_level_objectives' not in self._stubs:
            self._stubs['list_service_level_objectives'] = self.grpc_channel.unary_unary(
    ...
    def update_service_level_objective(self) -> Callable[
        ...
        if 'update_service_level_objective' not in self._stubs:
            self._stubs['update_service_level_objective'] = self.grpc_channel.unary_unary(
    ...
    def delete_service_level_objective(self) -> Callable[
        ...
        if 'delete_service_level_objective' not in self._stubs:
            self._stubs['delete_service_level_objective'] = self.grpc_channel.unary_unary(
