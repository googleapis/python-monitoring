...
class ServiceMonitoringServiceTransport(abc.ABC):
    ...
    def create_service(self) -> typing.Callable[
            ...
            typing.Union[
                gm_service.Service,
                typing.Awaitable[gm_service.Service]
            ]]:
    ...
    @property
    def create_service_level_objective(self) -> typing.Callable[
    ...
    @property
    def get_service_level_objective(self) -> typing.Callable[
    ...
    @property
    def list_service_level_objectives(self) -> typing.Callable[
    ...
    @property
    def update_service_level_objective(self) -> typing.Callable[
    ...
    @property
    def delete_service_level_objective(self) -> typing.Callable[
