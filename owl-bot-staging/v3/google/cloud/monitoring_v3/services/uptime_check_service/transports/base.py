...
class UptimeCheckServiceTransport(abc.ABC):
    ...
    @property
    def list_uptime_check_configs(self) -> typing.Callable[
            [uptime_service.ListUptimeCheckConfigsRequest],
            typing.Union[
                uptime_service.ListUptimeCheckConfigsResponse,
                typing.Awaitable[uptime_service.ListUptimeCheckConfigsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_uptime_check_config(self) -> typing.Callable[
            [uptime_service.GetUptimeCheckConfigRequest],
            typing.Union[
                uptime.UptimeCheckConfig,
                typing.Awaitable[uptime.UptimeCheckConfig]
            ]]:
        raise NotImplementedError()

    @property
    def create_uptime_check_config(self) -> typing.Callable[
    ...
    @property
    def update_uptime_check_config(self) -> typing.Callable[
    ...
    @property
    def delete_uptime_check_config(self) -> typing.Callable[
    ...
    @property
    def list_uptime_check_ips(self) -> typing.Callable[
            [uptime_service.ListUptimeCheckIpsRequest],
            typing.Union[
                uptime_service.ListUptimeCheckIpsResponse,
                typing.Awaitable[uptime_service.ListUptimeCheckIpsResponse]
            ]]:
        raise NotImplementedError()
