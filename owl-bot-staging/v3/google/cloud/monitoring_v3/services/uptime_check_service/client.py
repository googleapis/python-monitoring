...
class UptimeCheckServiceClient(metaclass=UptimeCheckServiceClientMeta):
    ...
    def uptime_check_config_path(project: str,uptime_check_config: str,) -> str:
        ...
        return "projects/{project}/uptimeCheckConfigs/{uptime_check_config}".format(project=project, uptime_check_config=uptime_check_config, )

    @staticmethod
    def parse_uptime_check_config_path(path: str) -> Dict[str,str]:
        """Parse a uptime_check_config path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/uptimeCheckConfigs/(?P<uptime_check_config>.+?)$", path)
    ...
    def list_uptime_check_configs(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_uptime_check_configs]
    ...
    def create_uptime_check_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_uptime_check_config]
    ...
    def update_uptime_check_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_uptime_check_config]
    ...
    def delete_uptime_check_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_uptime_check_config]
