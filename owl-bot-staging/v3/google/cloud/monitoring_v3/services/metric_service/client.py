...
class MetricServiceClient(metaclass=MetricServiceClientMeta):
    ...
    def get_monitored_resource_descriptor(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_monitored_resource_descriptor]
    ...
    def delete_metric_descriptor(self,
        ...
        .. code-block::
            ...
            def sample_delete_metric_descriptor():
                ...
                # Make the request
                response = client.delete_metric_descriptor(request=request)
    ...
    def create_time_series(self,
        ...
        .. code-block::
            ...
            def sample_create_time_series():
                ...
                # Make the request
                response = client.create_time_series(request=request)
    ...
    def create_service_time_series(self,
            request: Union[metric_service.CreateTimeSeriesRequest, dict] = None,
            *,
            name: str = None,
            time_series: Sequence[gm_metric.TimeSeries] = None,
        ...
        .. code-block::
            ...
            def sample_create_service_time_series():
                ...
                # Make the request
                response = client.create_service_time_series(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_service_time_series]
