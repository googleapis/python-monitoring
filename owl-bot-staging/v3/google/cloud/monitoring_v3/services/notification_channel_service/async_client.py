...
class NotificationChannelServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(NotificationChannelServiceClient).get_transport_class, type(NotificationChannelServiceClient))
    ...
    async def list_notification_channel_descriptors(self,
...
initial=0.1,maximum=30.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def get_notification_channel_descriptor(self,
...
initial=0.1,maximum=30.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def update_notification_channel(self,
    ...
    async def delete_notification_channel(self,
        ...
        .. code-block::
            ...
            def sample_delete_notification_channel():
                ...
                # Make the request
                response = client.delete_notification_channel(request=request)
...
initial=0.1,maximum=30.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def send_notification_channel_verification_code(self,
        ...
        .. code-block::
            ...
            def sample_send_notification_channel_verification_code():
                ...
                # Make the request
                response = client.send_notification_channel_verification_code(request=request)
    ...
    async def get_notification_channel_verification_code(self,
...
initial=0.1,maximum=30.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def verify_notification_channel(self,
