...
from google.cloud.monitoring_v3.services.service_monitoring_service import ServiceMonitoringServiceAsyncClient
from google.cloud.monitoring_v3.services.service_monitoring_service import ServiceMonitoringServiceClient
...
from google.cloud.monitoring_v3.services.service_monitoring_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_service_monitoring_service_client_service_account_always_use_jwt(client_class):
...
def test_service_monitoring_service_client_service_account_always_use_jwt_true(transport_class, transport_name):
    with mock.patch.object(service_account.Credentials, 'with_always_use_jwt_access', create=True) as use_jwt:
        creds = service_account.Credentials(None, None, None)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (ServiceMonitoringServiceClient, transports.ServiceMonitoringServiceGrpcTransport, "grpc"),
    (ServiceMonitoringServiceAsyncClient, transports.ServiceMonitoringServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (ServiceMonitoringServiceClient, transports.ServiceMonitoringServiceGrpcTransport, "grpc", "true"),
    (ServiceMonitoringServiceAsyncClient, transports.ServiceMonitoringServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (ServiceMonitoringServiceClient, transports.ServiceMonitoringServiceGrpcTransport, "grpc", "false"),
    (ServiceMonitoringServiceAsyncClient, transports.ServiceMonitoringServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(ServiceMonitoringServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ServiceMonitoringServiceClient))
@mock.patch.object(ServiceMonitoringServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ServiceMonitoringServiceAsyncClient))
...
def test_service_monitoring_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_create_service(transport: str = 'grpc', request_type=service_service.CreateServiceRequest):
    client = ServiceMonitoringServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_service(transport: str = 'grpc', request_type=service_service.GetServiceRequest):
    client = ServiceMonitoringServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_services(transport: str = 'grpc', request_type=service_service.ListServicesRequest):
    client = ServiceMonitoringServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_service(transport: str = 'grpc', request_type=service_service.UpdateServiceRequest):
    client = ServiceMonitoringServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_service(transport: str = 'grpc', request_type=service_service.DeleteServiceRequest):
    client = ServiceMonitoringServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_service_level_objective(transport: str = 'grpc', request_type=service_service.CreateServiceLevelObjectiveRequest):
    client = ServiceMonitoringServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_service_level_objective),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_service_level_objective_flattened():
    ...
    with mock.patch.object(
        ...
        _, args, _ = call.mock_calls[0]
        assert args[0].parent == 'parent_value'
        assert args[0].service_level_objective == service.ServiceLevelObjective(name='name_value')
...
def test_get_service_level_objective(transport: str = 'grpc', request_type=service_service.GetServiceLevelObjectiveRequest):
    client = ServiceMonitoringServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_service_level_objective),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.ServiceLevelObjective(
            name='name_value',
...
def test_list_service_level_objectives(transport: str = 'grpc', request_type=service_service.ListServiceLevelObjectivesRequest):
    client = ServiceMonitoringServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_service_level_objectives_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, service.ServiceLevelObjective)
                   for i in results)
...
def test_update_service_level_objective(transport: str = 'grpc', request_type=service_service.UpdateServiceLevelObjectiveRequest):
    client = ServiceMonitoringServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_service_level_objective),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.ServiceLevelObjective(
            name='name_value',
...
def test_delete_service_level_objective(transport: str = 'grpc', request_type=service_service.DeleteServiceLevelObjectiveRequest):
    client = ServiceMonitoringServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_service_level_objective),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_service_monitoring_service_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.monitoring_v3.services.service_monitoring_service.transports.ServiceMonitoringServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
...
@requires_google_auth_lt_1_25_0
def test_service_monitoring_service_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        ServiceMonitoringServiceClient()
...
@requires_google_auth_lt_1_25_0
def test_service_monitoring_service_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
