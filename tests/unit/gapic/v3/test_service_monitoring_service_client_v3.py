...
class TestServiceMonitoringServiceClient(object):
    ...
    def test_create_service(self):
        ...
        expected_request = service_service_pb2.CreateServiceRequest(parent=parent, service=service)
    ...
    def test_list_services(self):
        ...
        expected_response = service_service_pb2.ListServicesResponse(**expected_response)
    ...
    def test_create_service_level_objective(self):
        ...
        assert len(channel.requests) == 1
        expected_request = service_service_pb2.CreateServiceLevelObjectiveRequest(parent=parent, service_level_objective=service_level_objective)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_get_service_level_objective(self):
        ...
        assert len(channel.requests) == 1
        expected_request = service_service_pb2.GetServiceLevelObjectiveRequest(name=name)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_service_level_objectives(self):
        ...
        expected_response = service_service_pb2.ListServiceLevelObjectivesResponse(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = service_service_pb2.ListServiceLevelObjectivesRequest(parent=parent)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_update_service_level_objective(self):
        ...
        assert len(channel.requests) == 1
        expected_request = service_service_pb2.UpdateServiceLevelObjectiveRequest(service_level_objective=service_level_objective)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_delete_service_level_objective(self):
        ...
        assert len(channel.requests) == 1
        expected_request = service_service_pb2.DeleteServiceLevelObjectiveRequest(name=name)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
