...
class TestUptimeCheckServiceClient(object):
    ...
    def test_list_uptime_check_configs(self):
        ...
        expected_response = {'next_page_token': next_page_token, 'total_size': total_size, 'uptime_check_configs': uptime_check_configs}
        expected_response = uptime_service_pb2.ListUptimeCheckConfigsResponse(**expected_response)
        ...
        expected_request = uptime_service_pb2.ListUptimeCheckConfigsRequest(parent=parent)
    ...
    def test_get_uptime_check_config(self):
        ...
        is_internal = True
        expected_response = {'name': name_2, 'display_name': display_name, 'is_internal': is_internal}
    ...
    def test_create_uptime_check_config(self):
        ...
        display_name = 'displayName1615086568'
        is_internal = True
        expected_response = {'name': name, 'display_name': display_name, 'is_internal': is_internal}
        expected_response = uptime_pb2.UptimeCheckConfig(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = uptime_service_pb2.CreateUptimeCheckConfigRequest(parent=parent, uptime_check_config=uptime_check_config)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_update_uptime_check_config(self):
        ...
        assert len(channel.requests) == 1
        expected_request = uptime_service_pb2.UpdateUptimeCheckConfigRequest(uptime_check_config=uptime_check_config)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_uptime_check_ips(self):
        ...
        expected_response = uptime_service_pb2.ListUptimeCheckIpsResponse(**expected_response)
