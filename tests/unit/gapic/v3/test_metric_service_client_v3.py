...
class TestMetricServiceClient(object):
    ...
    def test_list_monitored_resource_descriptors(self):
        ...
        expected_response = metric_service_pb2.ListMonitoredResourceDescriptorsResponse(**expected_response)
        ...
        expected_request = metric_service_pb2.ListMonitoredResourceDescriptorsRequest(name=name)
    ...
    def test_get_monitored_resource_descriptor(self):
        ...
        expected_response = monitored_resource_pb2.MonitoredResourceDescriptor(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = metric_service_pb2.GetMonitoredResourceDescriptorRequest(name=name)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_metric_descriptors(self):
        ...
        expected_response = metric_service_pb2.ListMetricDescriptorsResponse(**expected_response)
    ...
    def test_get_metric_descriptor(self):
        ...
        description = 'description-1724546052'
        display_name = 'displayName1615086568'
        expected_response = {'name': name_2, 'type': type_, 'unit': unit, 'description': description, 'display_name': display_name}
    ...
    def test_create_metric_descriptor(self):
        ...
        assert len(channel.requests) == 1
        expected_request = metric_service_pb2.CreateMetricDescriptorRequest(name=name, metric_descriptor=metric_descriptor)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_time_series(self):
        ...
        expected_response = metric_service_pb2.ListTimeSeriesResponse(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = metric_service_pb2.ListTimeSeriesRequest(name=name, filter=filter_, interval=interval, view=view)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
