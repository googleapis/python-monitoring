...
class TestNotificationChannelServiceClient(object):
    ...
    def test_list_notification_channel_descriptors(self):
        ...
        expected_response = notification_service_pb2.ListNotificationChannelDescriptorsResponse(**expected_response)
        ...
        expected_request = notification_service_pb2.ListNotificationChannelDescriptorsRequest(name=name)
    ...
    def test_get_notification_channel_descriptor(self):
        ...
        expected_response = {'name': name_2, 'type': type_, 'display_name': display_name, 'description': description}
        expected_response = notification_pb2.NotificationChannelDescriptor(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = notification_service_pb2.GetNotificationChannelDescriptorRequest(name=name)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_notification_channels(self):
        ...
        expected_response = notification_service_pb2.ListNotificationChannelsResponse(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = notification_service_pb2.ListNotificationChannelsRequest(name=name)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_get_notification_channel(self):
        ...
        display_name = 'displayName1615086568'
        description = 'description-1724546052'
        expected_response = {'type': type_, 'name': name_2, 'display_name': display_name, 'description': description}
        ...
        assert len(channel.requests) == 1
        expected_request = notification_service_pb2.GetNotificationChannelRequest(name=name)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_create_notification_channel(self):
        ...
        assert len(channel.requests) == 1
        expected_request = notification_service_pb2.CreateNotificationChannelRequest(name=name, notification_channel=notification_channel)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_update_notification_channel(self):
        ...
        display_name = 'displayName1615086568'
        description = 'description-1724546052'
        expected_response = {'type': type_, 'name': name, 'display_name': display_name, 'description': description}
        expected_response = notification_pb2.NotificationChannel(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = notification_service_pb2.UpdateNotificationChannelRequest(notification_channel=notification_channel)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_delete_notification_channel(self):
        ...
        assert len(channel.requests) == 1
        expected_request = notification_service_pb2.DeleteNotificationChannelRequest(name=name)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_send_notification_channel_verification_code(self):
        ...
        assert len(channel.requests) == 1
        expected_request = notification_service_pb2.SendNotificationChannelVerificationCodeRequest(name=name)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_get_notification_channel_verification_code(self):
        ...
        expected_response = notification_service_pb2.GetNotificationChannelVerificationCodeResponse(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = notification_service_pb2.GetNotificationChannelVerificationCodeRequest(name=name)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
