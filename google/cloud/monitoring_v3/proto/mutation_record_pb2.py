...
_MUTATIONRECORD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='mutate_time', full_name='google.monitoring.v3.MutationRecord.mutate_time', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='mutated_by', full_name='google.monitoring.v3.MutationRecord.mutated_by', index=1,
...
_MUTATIONRECORD.fields_by_name['mutate_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
