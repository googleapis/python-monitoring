...
class AlertPolicyService(object):
    """The AlertPolicyService API is used to manage (list, create, delete,
    edit) alert policies in Stackdriver Monitoring. An alerting policy is
    a description of the conditions under which some aspect of your
    system is considered to be "unhealthy" and the ways to notify
    ...
    def ListAlertPolicies(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/google.monitoring.v3.AlertPolicyService/ListAlertPolicies",
            google_dot_cloud_dot_monitoring__v3_dot_proto_dot_alert__service__pb2.ListAlertPoliciesRequest.SerializeToString,
            google_dot_cloud_dot_monitoring__v3_dot_proto_dot_alert__service__pb2.ListAlertPoliciesResponse.FromString,
            options,
            channel_credentials,
            call_credentials,
            compression,
    ...
    def GetAlertPolicy(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/google.monitoring.v3.AlertPolicyService/GetAlertPolicy",
            google_dot_cloud_dot_monitoring__v3_dot_proto_dot_alert__service__pb2.GetAlertPolicyRequest.SerializeToString,
            google_dot_cloud_dot_monitoring__v3_dot_proto_dot_alert__pb2.AlertPolicy.FromString,
            options,
            channel_credentials,
            call_credentials,
            compression,
    ...
    def CreateAlertPolicy(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/google.monitoring.v3.AlertPolicyService/CreateAlertPolicy",
            google_dot_cloud_dot_monitoring__v3_dot_proto_dot_alert__service__pb2.CreateAlertPolicyRequest.SerializeToString,
            google_dot_cloud_dot_monitoring__v3_dot_proto_dot_alert__pb2.AlertPolicy.FromString,
            options,
            channel_credentials,
            call_credentials,
    ...
    def DeleteAlertPolicy(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/google.monitoring.v3.AlertPolicyService/DeleteAlertPolicy",
            google_dot_cloud_dot_monitoring__v3_dot_proto_dot_alert__service__pb2.DeleteAlertPolicyRequest.SerializeToString,
    ...
    def UpdateAlertPolicy(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/google.monitoring.v3.AlertPolicyService/UpdateAlertPolicy",
            google_dot_cloud_dot_monitoring__v3_dot_proto_dot_alert__service__pb2.UpdateAlertPolicyRequest.SerializeToString,
            google_dot_cloud_dot_monitoring__v3_dot_proto_dot_alert__pb2.AlertPolicy.FromString,
            options,
            channel_credentials,
            call_credentials,
