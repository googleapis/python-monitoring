...
from google.cloud.monitoring_v3.gapic.transports import uptime_check_service_grpc_transport
...
class UptimeCheckServiceClient(object):
    ...
    def list_uptime_check_configs(
        ...
        if 'list_uptime_check_configs' not in self._inner_api_calls:
            self._inner_api_calls['list_uptime_check_configs'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_uptime_check_configs'], retry=retry, timeout=timeout, metadata=metadata),
            request=request,
    ...
    def get_uptime_check_config(
        ...
        if 'get_uptime_check_config' not in self._inner_api_calls:
            self._inner_api_calls['get_uptime_check_config'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        request = uptime_service_pb2.GetUptimeCheckConfigRequest(
            name=name,
        )
        if metadata is None:
            metadata = []
        ...
        return self._inner_api_calls['get_uptime_check_config'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def create_uptime_check_config(
        ...
        if 'create_uptime_check_config' not in self._inner_api_calls:
            self._inner_api_calls['create_uptime_check_config'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['create_uptime_check_config'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def update_uptime_check_config(
        ...
        if 'update_uptime_check_config' not in self._inner_api_calls:
            self._inner_api_calls['update_uptime_check_config'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['update_uptime_check_config'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def delete_uptime_check_config(
        ...
        if 'delete_uptime_check_config' not in self._inner_api_calls:
            self._inner_api_calls['delete_uptime_check_config'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        self._inner_api_calls['delete_uptime_check_config'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def list_uptime_check_ips(
        ...
        if 'list_uptime_check_ips' not in self._inner_api_calls:
            self._inner_api_calls['list_uptime_check_ips'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_uptime_check_ips'], retry=retry, timeout=timeout, metadata=metadata),
            request=request,
